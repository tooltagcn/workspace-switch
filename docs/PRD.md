...
Claude Code、Codex、OpenCode、OpenClaude、Hermes、Cursor、GitHub Copilot、Qwen Code、Gemini CLI、Qoder、Factory、Droid、Aider、CodeBuddy、Kiro CLI、Pi（≥ 12 个）—— 每个模板预填其默认的 **配置目录名**（如 Claude Code = `.claude`、Codex = `.agents`）。
